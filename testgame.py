...
WHITE = (255,255,255)
X,Y = 40,50
PLAYER = pygame.transform.scale(pygame.image.load(os.path.join('healthbar','monster.png')),(X+50,Y+40))
FPS = 160
ENEMY_IMG = pygame.transform.scale(pygame.image.load(os.path.join('healthbar','monster 2.png')),(X,Y))
screen = pygame.display.set_mode((1550,820))
...
class HealthBar :
    ...
    def load_animations(self):
        self.health_animations = [pygame.image.load("C:/Users/Thainguyen/Downloads/healthbar/heart1.png").convert_alpha(),
                             pygame.image.load("C:/Users/Thainguyen/Downloads/healthbar/heart2.png").convert_alpha(),
                             pygame.image.load("C:/Users/Thainguyen/Downloads/healthbar/heart3.png").convert_alpha(),
                             pygame.image.load('C:/Users/Thainguyen/Downloads/healthbar/heart4.png').convert_alpha()
                                    ]
